...
app.delete('/students/:id', (req, res) => {
    let student = student.find((student) => {
        return student.is === req.params.id
    });
    ...
    if (student) {
        ...
        res.status(201).send('Students ' + req.params.id + ' was deleted');
    }
});

// update a students grade by name & class name
...
app.get('/students/:name/gpa', (req, res) => {
    ...
    if (student) {
        // Object.values() filters out object's keys and keeps the values that are returned as a new array
